...
import { A as clientAddressSymbol, C as isRoute404, D as DEFAULT_404_COMPONENT, E as ASTRO_GENERATOR, F as decryptString, I as generateCspDigest, M as originPathnameSymbol, N as responseSentSymbol$1, O as REDIRECT_STATUS_CODES, P as decodeKey, T as ASTRO_ERROR_HEADER, _ as normalizeCspResourceEntry, d as renderTemplate, g as isRenderInstruction, i as renderComponent, j as fetchStateSymbol, k as REROUTABLE_STATUS_CODES, l as renderSlotToString, n as renderPage, o as chunkToString, r as renderJSX, s as createSlotValueFromString, u as isRenderTemplateResult, v as pushDirective, w as isRoute500, x as renderEndpoint, y as isAstroComponentFactory } from "./chunks/server_CdMmoqFQ.mjs";
...
var middlewareSecret = "678afa67-80b5-4532-9d1d-efa4f6316f90";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/api/abrir/[slug].ts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/regalos/[id]/aprobar",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/regalos\\/([^/]+?)\\/aprobar\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": ["id"],
			"component": "src/pages/api/regalos/[id]/aprobar.ts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/regalos/[id]/eliminar",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/regalos\\/([^/]+?)\\/eliminar\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": ["id"],
			"component": "src/pages/api/regalos/[id]/eliminar.ts",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/no-disponible.astro",
			"pathname": "/no-disponible",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["slug"],
			"component": "src/pages/r/[slug].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["id"],
			"component": "src/pages/revisar/[id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_B6_zOs33.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/_slug__eYV7-C7u.mjs");
var _page2 = () => import("./chunks/aprobar_BVNTUKDY.mjs");
var _page3 = () => import("./chunks/eliminar_DMHYjvy3.mjs");
var _page4 = () => import("./chunks/no-disponible_CQTVd7X7.mjs");
var _page5 = () => import("./chunks/_slug__DOJk_3zh.mjs");
var _page6 = () => import("./chunks/_id__7Wx3cTDs.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/abrir/[slug].ts", _page1],
	["src/pages/api/regalos/[id]/aprobar.ts", _page2],
	["src/pages/api/regalos/[id]/eliminar.ts", _page3],
	["src/pages/no-disponible.astro", _page4],
	["src/pages/r/[slug].astro", _page5],
	["src/pages/revisar/[id].astro", _page6]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///Users/macbook/dev/regalos-qr/","cacheDir":"file:///Users/macbook/dev/regalos-qr/node_modules/.astro/","outDir":"file:///Users/macbook/dev/regalos-qr/dist/","srcDir":"file:///Users/macbook/dev/regalos-qr/src/","publicDir":"file:///Users/macbook/dev/regalos-qr/public/","buildClientDir":"file:///Users/macbook/dev/regalos-qr/dist/client/","buildServerDir":"file:///Users/macbook/dev/regalos-qr/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/abrir/[slug]","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/abrir\\/([^/]+?)\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"abrir","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/api/abrir/[slug].ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/regalos/[id]/aprobar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/regalos\\/([^/]+?)\\/aprobar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"regalos","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"aprobar","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/api/regalos/[id]/aprobar.ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/regalos/[id]/eliminar","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/regalos\\/([^/]+?)\\/eliminar\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"regalos","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}],[{"content":"eliminar","dynamic":false,"spread":false}]],"params":["id"],"component":"src/pages/api/regalos/[id]/eliminar.ts","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"*,:before,:after{box-sizing:border-box}html,body{margin:0;padding:0}html{max-width:100vw;overflow-x:hidden}body{background:var(--color-fondo,#fff);color:var(--color-texto,#111);font-family:system-ui,-apple-system,Segoe UI,sans-serif;line-height:1.5}img,picture,video{max-width:100%;display:block}h1,h2,h3,p{margin:0}button{font:inherit;color:inherit;cursor:pointer;background:0 0;border:none}:focus-visible{outline:2px solid var(--color-foco,currentColor);outline-offset:2px}#pantalla-apertura{text-align:center;background:var(--color-fondo);width:100%;height:100%;color:var(--color-texto);z-index:10;flex-direction:column;justify-content:center;align-items:center;gap:1.5rem;padding:2rem;display:flex;position:fixed;inset:0}#pantalla-apertura p{max-width:28rem;font-size:1.5rem}.boton-abrir{color:var(--color-texto-sobre-acento);background:var(--color-acento);border-radius:999px;padding:.75rem 1.75rem;font-weight:600;display:inline-block}#contenido{flex-direction:column;gap:2rem;max-width:40rem;margin:0 auto;padding:1.5rem;display:flex}.foto-marco{background:var(--color-superficie);border-radius:.5rem;justify-content:center;align-items:center;width:100%;max-height:70vh;display:flex;overflow:hidden}.foto-marco img{object-fit:contain;width:100%;height:100%}h1,h2,h3,p,a,span,time,button{overflow-wrap:anywhere}[data-bloque=carta] p,[data-bloque=momento] p{white-space:pre-wrap}@media (prefers-reduced-motion:reduce){*,:before,:after{scroll-behavior:auto!important;transition-duration:.001ms!important;animation-duration:.001ms!important;animation-iteration-count:1!important}}\n"}],"routeData":{"route":"/no-disponible","isIndex":false,"type":"page","pattern":"^\\/no-disponible\\/?$","segments":[[{"content":"no-disponible","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/no-disponible.astro","pathname":"/no-disponible","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"*,:before,:after{box-sizing:border-box}html,body{margin:0;padding:0}html{max-width:100vw;overflow-x:hidden}body{background:var(--color-fondo,#fff);color:var(--color-texto,#111);font-family:system-ui,-apple-system,Segoe UI,sans-serif;line-height:1.5}img,picture,video{max-width:100%;display:block}h1,h2,h3,p{margin:0}button{font:inherit;color:inherit;cursor:pointer;background:0 0;border:none}:focus-visible{outline:2px solid var(--color-foco,currentColor);outline-offset:2px}#pantalla-apertura{text-align:center;background:var(--color-fondo);width:100%;height:100%;color:var(--color-texto);z-index:10;flex-direction:column;justify-content:center;align-items:center;gap:1.5rem;padding:2rem;display:flex;position:fixed;inset:0}#pantalla-apertura p{max-width:28rem;font-size:1.5rem}.boton-abrir{color:var(--color-texto-sobre-acento);background:var(--color-acento);border-radius:999px;padding:.75rem 1.75rem;font-weight:600;display:inline-block}#contenido{flex-direction:column;gap:2rem;max-width:40rem;margin:0 auto;padding:1.5rem;display:flex}.foto-marco{background:var(--color-superficie);border-radius:.5rem;justify-content:center;align-items:center;width:100%;max-height:70vh;display:flex;overflow:hidden}.foto-marco img{object-fit:contain;width:100%;height:100%}h1,h2,h3,p,a,span,time,button{overflow-wrap:anywhere}[data-bloque=carta] p,[data-bloque=momento] p{white-space:pre-wrap}@media (prefers-reduced-motion:reduce){*,:before,:after{scroll-behavior:auto!important;transition-duration:.001ms!important;animation-duration:.001ms!important;animation-iteration-count:1!important}}\n"}],"routeData":{"route":"/r/[slug]","isIndex":false,"type":"page","pattern":"^\\/r\\/([^/]+?)\\/?$","segments":[[{"content":"r","dynamic":false,"spread":false}],[{"content":"slug","dynamic":true,"spread":false}]],"params":["slug"],"component":"src/pages/r/[slug].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"*,:before,:after{box-sizing:border-box}html,body{margin:0;padding:0}html{max-width:100vw;overflow-x:hidden}body{background:var(--color-fondo,#fff);color:var(--color-texto,#111);font-family:system-ui,-apple-system,Segoe UI,sans-serif;line-height:1.5}img,picture,video{max-width:100%;display:block}h1,h2,h3,p{margin:0}button{font:inherit;color:inherit;cursor:pointer;background:0 0;border:none}:focus-visible{outline:2px solid var(--color-foco,currentColor);outline-offset:2px}#pantalla-apertura{text-align:center;background:var(--color-fondo);width:100%;height:100%;color:var(--color-texto);z-index:10;flex-direction:column;justify-content:center;align-items:center;gap:1.5rem;padding:2rem;display:flex;position:fixed;inset:0}#pantalla-apertura p{max-width:28rem;font-size:1.5rem}.boton-abrir{color:var(--color-texto-sobre-acento);background:var(--color-acento);border-radius:999px;padding:.75rem 1.75rem;font-weight:600;display:inline-block}#contenido{flex-direction:column;gap:2rem;max-width:40rem;margin:0 auto;padding:1.5rem;display:flex}.foto-marco{background:var(--color-superficie);border-radius:.5rem;justify-content:center;align-items:center;width:100%;max-height:70vh;display:flex;overflow:hidden}.foto-marco img{object-fit:contain;width:100%;height:100%}h1,h2,h3,p,a,span,time,button{overflow-wrap:anywhere}[data-bloque=carta] p,[data-bloque=momento] p{white-space:pre-wrap}@media (prefers-reduced-motion:reduce){*,:before,:after{scroll-behavior:auto!important;transition-duration:.001ms!important;animation-duration:.001ms!important;animation-iteration-count:1!important}}\n[data-astro-cid-xgjxelw6][data-panel-revision]{z-index:20;text-align:center;background:var(--color-superficie);color:var(--color-texto-sobre-superficie);padding:1rem;position:fixed;bottom:0;left:0;right:0}[data-astro-cid-xgjxelw6][data-form-aprobar] button[data-astro-cid-xgjxelw6]{color:var(--color-texto-sobre-acento);background:var(--color-acento);border-radius:999px;padding:.6rem 1.5rem;font-weight:600}\n"}],"routeData":{"route":"/revisar/[id]","isIndex":false,"type":"page","pattern":"^\\/revisar\\/([^/]+?)\\/?$","segments":[[{"content":"revisar","dynamic":false,"spread":false}],[{"content":"id","dynamic":true,"spread":false}]],"params":["id"],"component":"src/pages/revisar/[id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/Users/macbook/dev/regalos-qr/src/pages/r/[slug].astro",{"propagation":"none","containsHead":true}],["/Users/macbook/dev/regalos-qr/src/pages/revisar/[id].astro",{"propagation":"none","containsHead":true}],["/Users/macbook/dev/regalos-qr/src/pages/no-disponible.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/revisar/[id]@_@astro":"chunks/_id__7Wx3cTDs.mjs","\u0000virtual:astro:page:src/pages/r/[slug]@_@astro":"chunks/_slug__DOJk_3zh.mjs","\u0000virtual:astro:page:src/pages/api/abrir/[slug]@_@ts":"chunks/_slug__eYV7-C7u.mjs","\u0000virtual:astro:page:src/pages/api/regalos/[id]/aprobar@_@ts":"chunks/aprobar_BVNTUKDY.mjs","\u0000virtual:astro:page:src/pages/api/regalos/[id]/eliminar@_@ts":"chunks/eliminar_DMHYjvy3.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_B6_zOs33.mjs","\u0000virtual:astro:page:src/pages/no-disponible@_@astro":"chunks/no-disponible_CQTVd7X7.mjs","/Users/macbook/dev/regalos-qr/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_BBtXrEHn.mjs","/Users/macbook/dev/regalos-qr/src/bloques/Cancion.astro?astro&type=script&index=0&lang.ts":"_astro/Cancion.astro_astro_type_script_index_0_lang.ICV6_oUf.js","/Users/macbook/dev/regalos-qr/src/bloques/Contador.astro?astro&type=script&index=0&lang.ts":"_astro/Contador.astro_astro_type_script_index_0_lang.BxgNIA7Q.js","/Users/macbook/dev/regalos-qr/src/bloques/Pregunta.astro?astro&type=script&index=0&lang.ts":"_astro/Pregunta.astro_astro_type_script_index_0_lang.CBc2iDdk.js","/Users/macbook/dev/regalos-qr/src/layouts/RegaloLayout.astro?astro&type=script&index=0&lang.ts":"_astro/RegaloLayout.astro_astro_type_script_index_0_lang.GISkBUhY.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["/Users/macbook/dev/regalos-qr/src/bloques/Cancion.astro?astro&type=script&index=0&lang.ts","document.querySelectorAll(`[data-bloque=\"cancion\"]`).forEach(e=>{let t=e.querySelector(`[data-boton-cancion]`),n=e.querySelector(`[data-contenedor-embed]`),r=e.dataset.embedUrl;!t||!n||!r||t.addEventListener(`click`,()=>{let e=document.createElement(`iframe`);e.src=r,e.loading=`lazy`,e.allow=`encrypted-media`,e.title=t.textContent?.trim()||`Reproductor`,n.appendChild(e),t.hidden=!0},{once:!0})});"],["/Users/macbook/dev/regalos-qr/src/bloques/Contador.astro?astro&type=script&index=0&lang.ts","function e(e){return`${Math.floor(e/86400)}d ${Math.floor(e%86400/3600)}h ${Math.floor(e%3600/60)}m ${e%60}s`}document.querySelectorAll(`[data-bloque=\"contador\"]`).forEach(t=>{let n=new Date(t.dataset.fechaInicio??``).getTime(),r=t.querySelector(`[data-contador-valor]`);if(!r||Number.isNaN(n))return;function i(){let t=Date.now()-n,i=Math.max(0,Math.floor(Math.abs(t)/1e3));r.dataset.segundos=String(i),r.textContent=e(i)}i(),setInterval(i,1e3)});"],["/Users/macbook/dev/regalos-qr/src/bloques/Pregunta.astro?astro&type=script&index=0&lang.ts","document.querySelectorAll(`[data-boton-pregunta]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.closest(`[data-bloque=\"pregunta\"]`)?.querySelector(`[data-respuesta]`);if(!t)return;let n=e.getAttribute(`aria-expanded`)===`true`;e.setAttribute(`aria-expanded`,String(!n)),t.hidden=n})});"],["/Users/macbook/dev/regalos-qr/src/layouts/RegaloLayout.astro?astro&type=script&index=0&lang.ts","var e=document.getElementById(`pantalla-apertura`),t=document.getElementById(`contenido`);function n(){if(!e||!t)return;let n=e.dataset.slug;t.hidden=!1,e.remove(),n&&fetch(`/api/abrir/${n}`,{method:`POST`,keepalive:!0}).catch(()=>{})}e?.addEventListener(`click`,n,{once:!0});"]],"assets":[],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"S65EDcS0bVk+HUmGcVNkJKhQdaTC4jTytPumIA1ivbI=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/macbook/dev/regalos-qr/node_modules/.bin/astro" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/Users/macbook/dev/regalos-qr/node_modules/.bin/astro" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "678afa67-80b5-4532-9d1d-efa4f6316f90") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
